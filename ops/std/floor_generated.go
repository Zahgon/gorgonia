...
type floorOp[DT any] struct{ unop }

// String implements fmt.Stringer.
func (op floorOp[DT]) String() string { return "⌊·⌋" }

// Do performs elementwise floor.
func (op floorOp[DT]) Do(ctx context.Context, vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
...
func (op floorOp[DT]) PreallocDo(ctx context.Context, prealloc tensor.Basic[DT], vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
	if err := internal.HandleCtx(ctx); err != nil {
		return retVal, err
	}
