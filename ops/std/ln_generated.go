...
type lnOp[DT any] struct{ unop }

// String implements fmt.Stringer.
func (op lnOp[DT]) String() string { return "Ln" }

// Do performs elementwise ln.
func (op lnOp[DT]) Do(ctx context.Context, vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
...
func (op lnOp[DT]) PreallocDo(ctx context.Context, prealloc tensor.Basic[DT], vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
	if err := internal.HandleCtx(ctx); err != nil {
		return retVal, err
	}
...
func (op lnOp[DT]) DiffWRT(inputs int) []bool { return onetrue }
