...
type expOp[DT any] struct{ unop }

// String implements fmt.Stringer.
func (op expOp[DT]) String() string { return "Exp" }

// Do performs elementwise exp.
func (op expOp[DT]) Do(ctx context.Context, vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
...
func (op expOp[DT]) PreallocDo(ctx context.Context, prealloc tensor.Basic[DT], vs ...tensor.Basic[DT]) (retVal tensor.Basic[DT], err error) {
	if err := internal.HandleCtx(ctx); err != nil {
		return retVal, err
	}
...
func (op expOp[DT]) DiffWRT(inputs int) []bool { return onetrue }
